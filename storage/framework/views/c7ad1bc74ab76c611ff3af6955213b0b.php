        ...
        <div class="w-full max-w-lg p-6 bg-white rounded-lg shadow-md">
            ...
            <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-center my-6">
                    <div class="relative">
                        <img id="profilePic"
                            src="<?php echo e(Auth::user()->profile_picture ? 'storage/' . Auth::user()->profile_picture : 'https://via.placeholder.com/100'); ?>"
                ...
                <div class="relative mb-4">
                    <input type="text" name="name" placeholder="" value="<?php echo e(Auth::user()->name); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\awang\code-academy-main\code-academy-main\resources\views/profile.blade.php ENDPATH**/ ?>