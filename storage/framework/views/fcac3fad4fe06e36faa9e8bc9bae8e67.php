...
<?php $__env->startSection('admin-content'); ?>
    <div class="container px-4 py-10 mx-auto">
        ...
        <form action="<?php echo e(route('admin.chapters.articles.store', ['chapter' => $chapter, 'course' => $course])); ?>"
            method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\awang\code-academy-main\code-academy-main\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>