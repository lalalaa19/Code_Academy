<?php $__env->startSection('title', 'Bantuan - CodeAcademy'); ?>
                ...
                <?php for($i = 1; $i <= 6; $i++): ?>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">Username <?php echo e($i); ?></h3>
                        </div>
                        <p class="text-gray-600 text-sm">
        ...
        <div class="container mx-auto  px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-pink-200 rounded-2xl flex items-center justify-center flex-col aspect-square">
                    <img src="<?php echo e(asset('image/ig.png')); ?>" alt="" class="w-36">
                    <p class="mt-5 text-lg font-semibold text-gray-600">@codeacademy</p>
                </div>
                <div class="bg-pink-200 rounded-2xl flex items-center justify-center flex-col aspect-square">
                    <img src="<?php echo e(asset('image/wa.png')); ?>" alt="" class="w-36">
                    <p class="mt-5 text-lg font-semibold text-gray-600">0896 4347 4489</p>
                </div>
                <div class="bg-pink-200 rounded-2xl flex items-center justify-center flex-col aspect-square">
                    <img src="<?php echo e(asset('image/email.png')); ?>" alt="" class="w-36">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\awang\code-academy-main\code-academy-main\resources\views/help.blade.php ENDPATH**/ ?>