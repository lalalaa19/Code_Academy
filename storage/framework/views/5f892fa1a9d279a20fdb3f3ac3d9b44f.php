...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CodeAcademy'); ?></title>
...
<body class="bg-light font-poppins">
    <header class="text-white bg-primary">
        <nav class="container flex items-center justify-between px-6 py-4 mx-auto">
            <a href="<?php echo e(route('landing')); ?>" class="text-2xl font-bold text-light">CodeAcademy</a>
            <div class="flex items-center text-lg space-x-2">
                <a href="<?php echo e(route('landing')); ?>" class="text-white px-4 py-2 font-medium">Beranda</a>
                <a href="<?php echo e(route('courses')); ?>" class="text-white px-4 py-2 font-medium">Kursus</a>
                <a href="<?php echo e(route('help')); ?>" class="text-white px-4 py-2 font-medium">Bantuan</a>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('profile')); ?>" class="text-white px-4 py-2 font-medium">Profil</a>
                    <?php if(auth()->user()->role === 'admin'): ?>
                        <a href="<?php echo e(route('admin.courses.index')); ?>" class="text-white px-4 py-2 font-medium">Dashboard</a>
                    <?php endif; ?>
...
<?php /**PATH D:\awang\code-academy-main\code-academy-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>